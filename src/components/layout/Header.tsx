...
import { User, LogOut, Menu, X, Sparkles, Bot } from 'lucide-react';
...
import { CustomizeAIDialog } from '@/components/ui/customize-ai-dialog';
                                ...
                                {session && (
                                    <>
                                        <button
                                            ...
                                            className="flex items-center gap-2 text-sm font-medium text-foreground/60 hover:text-foreground w-full"
                                        >
                                            <Bot className="w-4 h-4" />
                                            Customize AI
                                        </button>
